      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              <p>
                I am a 20-year-old content creator and founder building
              ...
              <p>
                Project 300K is the 180-day public challenge where I grow this
                brand to 300,000 followers across TikTok, Instagram, and YouTube
                Shorts, while building a real business around it. I document
                everything.
              </p>
            </div>

            <div className="flex flex-wrap gap-3">
              {["2M+ Monthly Reach", "Active Discord Community"].map((label) => (
                <div
                  key={label}
